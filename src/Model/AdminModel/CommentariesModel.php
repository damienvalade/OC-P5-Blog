...
class CommentariesModel extends Model
{
    ...
    {
        $querry = 'SELECT articles.nom_article, commentaire.commentaire, commentaire.is_valide, users.firstname, commentaire.date_creation, commentaire.id, commentaire.id_article
                    FROM commentaire
